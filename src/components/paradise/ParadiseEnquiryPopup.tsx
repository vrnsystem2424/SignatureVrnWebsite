...
interface ParadiseEnquiryPopupProps {
  isOpen: boolean;
  onClose: () => void;
}

export default function ParadiseEnquiryPopup({ isOpen, onClose }: ParadiseEnquiryPopupProps) {
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          animation: isOpen ? "scaleUpBounce 0.45s cubic-bezier(0.34, 1.56, 0.64, 1) forwards" : undefined,
        }}
      >
        {/* Top accent */}
          ...
          {submitted ? (
            <div className="text-center py-8">
              ...
              <p className="text-sm text-slate-600 leading-relaxed">
                Your enquiry for <strong>Signature Paradise</strong> has been received.
