...
//   // ✅ Success Screen Component (reusable for desktop and mobile)
...
//         } mx-auto bg-gradient-to-br from-green-400 to-green-600 rounded-full flex items-center justify-center mb-4 shadow-lg`}
//       >
//         <svg
...
//         className={`text-slate-600 ${isMobile ? "text-xs" : "text-sm"} mb-1`}
//       >
...
//         className={`text-slate-500 ${isMobile ? "text-xs" : "text-sm"} mb-4`}
//       >
...
//           className="inline-flex items-center justify-center gap-2 text-amber-600 font-semibold text-sm hover:text-amber-700"
//         >
//           <svg
//             className="h-4 w-4"
//             viewBox="0 0 24 24"
...
//                     🏗️ <strong className="text-white">135 Premium Flats</strong>{" "}
//                     | 96.3% Sold Out
//                   </p>
//                   <p className="text-lg text-slate-300">
//                     🏆 <strong className="text-white">Only 5 Units Left</strong>{" "}
//                     - Last Chance!
//                   </p>
//                   <p className="text-lg text-slate-300">
//                     📍{" "}
//                     <strong className="text-white">Main Road Location</strong> |
//                     Near Aura Mall, Bansal Hospital
//                   </p>
//                 </div>
...
//                 className="-ml-8"
//               >
//                 <div className="relative bg-white rounded-3xl p-8 shadow-2xl min-h-[500px] flex flex-col justify-center">
...
//                           Get{" "}
//                           <span className="text-amber-500">Best Price</span>
//                         </h3>
...
//                           className="w-full rounded-xl bg-gray-50 border border-gray-200 px-4 py-3 text-slate-900 placeholder:text-slate-400 focus:border-amber-500 focus:outline-none focus:ring-2 focus:ring-amber-500/20 transition-all disabled:opacity-60"
//                           value={formData.name}
//                           onChange={(e) =>
...
//                         <select
//                           required
//                           className="w-full rounded-xl bg-gray-50 border border-gray-200 px-4 py-3 text-slate-900 focus:border-amber-500 focus:outline-none focus:ring-2 focus:ring-amber-500/20 transition-all disabled:opacity-60"
...
//             >
//               <div className="bg-white rounded-2xl p-6 shadow-xl min-h-[420px] flex flex-col justify-center">
...
//                         required
//                         placeholder="Full Name"
//                         className="w-full rounded-xl bg-gray-50 border border-gray-200 px-4 py-3 text-slate-900 placeholder:text-slate-400 focus:border-amber-500 focus:outline-none text-sm disabled:opacity-60"
//                         value={formData.name}
//                         onChange={(e) =>
//                           setFormData({ ...formData, name: e.target.value })
//                         }
...
//                       <select
//                         required
//                         className="w-full rounded-xl bg-gray-50 border border-gray-200 px-4 py-3 text-slate-900 focus:border-amber-500 focus:outline-none text-sm disabled:opacity-60"
//                         value={formData.requirement}
//                         onChange={(e) =>
//                           setFormData({
//                             ...formData,
...
//           {/* WhatsApp Button */}
//           <a
//             href="https://wa.me/919203403607?text=Hi,%20I'm%20interested%20in%20Ultimate%20Heights"
//             target="_blank"
...
export default function Hero() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // ✅ GTM dataLayer push - Hero Form
      if (typeof window !== "undefined") {
        (window as any).dataLayer = (window as any).dataLayer || [];
        (window as any).dataLayer.push({
          event: "generate_lead",
          form_name: "Hero Form",
          form_source: "Hero Section",
